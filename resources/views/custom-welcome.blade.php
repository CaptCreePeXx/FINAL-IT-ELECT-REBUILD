...
<body class="w-screen min-h-screen bg-gradient-to-br from-[#E8F0F1] via-[#BDDBD1] to-[#FBF9F1] flex flex-col items-center pt-20">
    ...
    <div class="relative z-10 w-full max-w-7xl text-center px-8">
        ...
        <!-- Why Choose Section -->
        <div class="mt-6 mb-8 max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold text-[#2F3E3C] mb-4">Why Choose Smile Point?</h2>
            <p class="text-[#2F3E3C] text-sm md:text-base">
                Our Dental Clinic Management System helps you manage appointments, patient records, and treatments effortlessly. Stay organized, reduce errors, and provide your patients with a seamless experience.
            </p>
        </div>
...
<div class="mt-20 flex justify-center">
    ...
    rounded-3xl shadow-lg transform transition-transform duration-300 hover:scale-105">
        ...
        <ul class="space-y-4 text-center text-base md:text-lg text-[#2F3E3C]">
            <li><span class="font-semibold">Teeth Cleaning:</span><br>Removes plaque, tartar, and stains.</li>
            <li><span class="font-semibold">Tooth Extraction:</span><br>Safe removal of damaged teeth.</li>
            <li><span class="font-semibold">Dental Filling:</span><br>Restores teeth with cavities.</li>
            <li><span class="font-semibold">Root Canal:</span><br>Removes infection and saves teeth.</li>
            <li><span class="font-semibold">Braces Consultation:</span><br>Orthodontic evaluation.</li>
            <li><span class="font-semibold">Check-up:</span><br>Routine oral examinations.</li>
        </ul>
    </div>
</div>
        ...
        <!-- Mission Statement -->
        <div class="mt-24 max-w-5xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-[#2F3E3C] mb-4">Our Mission</h2>
            <p class="text-[#2F3E3C] text-base md:text-lg leading-relaxed">
                At Smile Point Dental Clinic, we aim to deliver high-quality, accessible, and compassionate dental care. Our commitment is to ensure your comfort, confidence, and long-term oral health.
            </p>
        </div>
        ...
        <div class="mt-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
                ...
                <div class="bg-[#FBF9F1] p-6 rounded-3xl shadow-lg border-2 border-[#2F3E3C] hover:scale-105 transition-transform">
                    <div class="flex text-3xl font-bold mb-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-transparent bg-clip-text">★★★★★</div>
